...
- GitHub → the [wickra-radar repository](https://github.com/wickra-lib/wickra-radar)
...
Wickra Radar parses untrusted `RadarSpec` JSON and event data, so its parser and
...
[SECURITY.md](https://github.com/wickra-lib/wickra-radar/blob/main/SECURITY.md)
